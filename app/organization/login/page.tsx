            ...
            <div className="w-full max-w-md bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 p-8 relative z-10 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="text-center space-y-1">
                        <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Onward Partner Portal</h1>
                        <p className="text-slate-500">Secure access for organization administrators</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <div className="text-center">
                        <Link href="/" className="text-sm text-slate-500 hover:text-emerald-600 transition-colors inline-flex items-center gap-1 group">
