        ...
        <div className="w-full mt-4 flex flex-col gap-4">
            ...
            >
                ...
                {chatMessages.map((msg) => {
                    ...
                    const isAgent = !isMe; // Assume if it's not me, it's Keith (simplifies identity issues)
                        ...
                        <div key={msg.timestamp} className={cn("flex w-full", isAgent ? "justify-start" : "justify-end")}>
                            <div className={cn(
                                ...
                                {isAgent ? (
                                    ...
                                    <span className="text-[10px] font-bold text-slate-400 block mb-1 uppercase tracking-wider text-right">USER</span>
                                )}
                                {(() => {
